...
def read_input():
    ...
    path = os.path.join(my_path, "day17.in")
...
class Rock:
    ...
    # return to the position in tuple
...
class Cave:
    ...
    def _spawn_rock(self):
        self.falling_rock = Rock(next(self.rock_type_generator)[0], 2, self.highest + 4)
    ...
    # has the rock collided in the cave
    ...
    def step(self):
        ...
        # do we have a falling rock or should one start falling
...
def part1(rocks=2022):
    ...
    while cave.rock_counter < rocks:
        cave.step()
    print(f'Part 1: the height after 2022 rocks is: ' + str(cave.highest + 1))
